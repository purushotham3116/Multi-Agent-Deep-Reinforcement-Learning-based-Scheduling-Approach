...
<div class="main">
  <div class="header">
    <div class="header_resize">
      <div class="logo">
        <h1><a href="index.html" class="style6">Multi Agent Deep Reinforcement Learning based Scheduling Approach for Mobile Charging in Internet of Electric VehiclesUsing Stacked Ensemble GCR-NN Model
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
		...
		<iframe width="650" height="700" src="U_View_All_Datasets1.jsp"></iframe>
