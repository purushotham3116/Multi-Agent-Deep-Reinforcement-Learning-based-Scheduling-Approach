...
<head>
<title>CLOUD SERVER Login Page</title>
...
function valid()
{
var na3=document.s.CLOUD SERVERid.value;
if(na3=="")

{
alert("Please Enter User Name");
document.s.CLOUD SERVERid.focus();
return false;
}
else
{
...
<div class="main">
  <div class="header">
    <div class="header_resize">
      ...
      <div class="clr"></div>
      <div class="slider">
        <div id="coin-slider"> <a href="#"><img src="images/slide1.jpg" width="920" height="360" alt="" /><span><big>Sed </big></span><img src="images/slide2.jpg" width="920" height="360" alt="" /><span>estie.</span></a> <a href="#"></a> <a href="#"><img src="images/slide3.jpg" width="920" height="360" alt="" /><span><big>Sed </big></span></a> </div>
        <div class="clr"></div>
      </div>
      <div class="clr"></div>
    </div>
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2><span class="style8">Wel-Come CLOUD SERVER Login </span></h2>
         
		  <form name="s" action="Authentication.jsp?value=<%="cloudlogin"%>" method="post" onSubmit="return valid()"  ons target="_top">
              <table width="660" align="left">
                  <tr>
                    <td width="162" height="35"><span class="style6">User Name (required)</span></td>
                    <td width="486"><input id="name" name="cloudid" class="text" /></td>
                  </tr>
                  <tr>
